...
for i in range(1, 33):
    ...
    url = f"https://github.com/Methusan105/Games-and-Programs/releases/download/ACS/Assassin.s.Creed.-.Syndicate.-.Gold.Edition.zip.{number_str}"
