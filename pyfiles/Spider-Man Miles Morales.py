...
for i in range(1, 26):
    ...
    url = f"https://github.com/Methusan105/Games-and-Programs/releases/download/MSMMM/Marvels.Spider-Man.Miles.Morales.zip.{number_str}"
