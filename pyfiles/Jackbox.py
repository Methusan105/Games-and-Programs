...
for i in range(1, 7):
    ...
    url = f"https://github.com/Methusan105/Games-and-Programs/releases/download/Jackbox/The.Jackbox.Party.Pack.tar.{number_str}"
...
def run_extraction_thread():
    ...
    try:
        ...
        zip_file_name = "The.Jackbox.Party.Pack.tar"
