...
for i in range(1, 35):
    ...
    url = f"https://github.com/Methusan105/Games-and-Programs/releases/download/Spider-Man/Spider-Man.Remastered.zip.{number_str}"
