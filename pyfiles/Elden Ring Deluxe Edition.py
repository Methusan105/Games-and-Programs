...
for i in range(1, 27):
    ...
    url = f"https://github.com/Methusan105/Games-and-Programs/releases/download/ERD/Elden.Ring.Deluxe.Edition.zip.{number_str}"
