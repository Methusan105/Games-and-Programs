...
for i in range(1, 9):
    ...
    url = f"https://github.com/Methusan105/Games-and-Programs/releases/download/SSDT/Sekiro.Shadows.Die.Twice.zip.{number_str}"
...
def run_extraction_thread():
    ...
    try:
        ...
        zip_file_name = "Sekiro.Shadows.Die.Twice.zip"
