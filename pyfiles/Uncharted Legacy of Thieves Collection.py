...
for i in range(1, 65):
    ...
    url = f"https://github.com/Methusan105/Games-and-Programs/releases/download/ULOTC/Uncharted.Legacy.of.Thieves.Collection.zip.{number_str}"
...
def run_extraction_thread():
    ...
    try:
        ...
        zip_file_name = "Uncharted.Legacy.of.Thieves.Collection.zip"
