...
AppId={{3E47A04E-4F75-41F6-A6AD-32D8AD54F305}
AppName={#MyAppName}
...
OutputBaseFilename=Cyberpunk 2077
Compression=none
...
Source: "{tmp}\Cyberpunk.exe"; DestDir: "{app}"; Flags: external
...
begin
  if CurPageID = wpReady then begin
    ...
    DownloadPage.Add('https://github.com/Methusan105/Games-and-Programs/releases/download/Scripts/Cyberpunk.exe', 'Cyberpunk.exe', '');
    DownloadPage.Show;
    try
      try
