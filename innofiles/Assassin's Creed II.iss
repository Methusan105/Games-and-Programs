...
AppId={{F0C43F09-61F6-4367-9939-43202807E1F8}
AppName={#MyAppName}
...
OutputBaseFilename=Assassin's Creed II
Compression=none
...
Source: "{tmp}\Assassin's Creed II.exe"; DestDir: "{app}"; Flags: external
...
begin
  if CurPageID = wpReady then begin
    ...
    DownloadPage.Add('https://github.com/Methusan105/Games-and-Programs/releases/download/Scripts/Assassins.Creed.II.exe', 'Assassins Creed II.exe', '');
    DownloadPage.Show;
    try
      try
...
[Run]
Filename:"{app}\Assassins Creed II.exe"