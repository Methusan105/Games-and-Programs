...
#define MyAppName "The Last Of Us"
#define MyAppVersion "1.0"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{367B0B7B-6744-4437-B3B0-9D860340EE83}
AppName={#MyAppName}
...
OutputBaseFilename=The Last Of Us
Compression=none
...
Source: "{tmp}\The Last Of Us.exe"; DestDir: "{app}"; Flags: external
...
begin
  if CurPageID = wpReady then begin
    ...
    DownloadPage.Add('https://github.com/Methusan105/Games-and-Programs/releases/download/Scripts/The.Last.Of.Us.exe', 'The Last Of Us.exe', '');
    DownloadPage.Show;
    try
      try
...
[Run]
Filename:"{app}\The Last Of Us.exe"