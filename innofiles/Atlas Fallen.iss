...
#define MyAppName "Atlas Fallen"
#define MyAppVersion "1.0"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{6BFE2C8F-33B7-4593-8857-FED00A28FA96}
AppName={#MyAppName}
...
OutputBaseFilename=Atlas Fallen
Compression=none
...
Source: "{tmp}\Atlas Fallen.exe"; DestDir: "{app}"; Flags: external
...
begin
  if CurPageID = wpReady then begin
    ...
    DownloadPage.Add('https://github.com/Methusan105/Games-and-Programs/releases/download/Scripts/Atlas.Fallen.exe', 'Atlas Fallen.exe', '');
    DownloadPage.Show;
    try
      try
