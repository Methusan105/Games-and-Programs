...
#define MyAppName "GTA V"
#define MyAppVersion "1.0"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{956D1500-88DD-4223-B74F-131801A7633F}
AppName={#MyAppName}
...
Source: "{tmp}\GTA V.exe"; DestDir: "{app}"; Flags: external
...
begin
  if CurPageID = wpReady then begin
    ...
    DownloadPage.Add('https://github.com/Methusan105/Games-and-Programs/releases/download/Scripts/GTA.V.exe', 'GTA V.exe', '');
    DownloadPage.Show;
    try
      try
