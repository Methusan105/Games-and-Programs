...
AppId={{5955AA9D-CD15-4B80-9E66-9F45060E39E1}
AppName={#MyAppName}
...
Source: "{tmp}\God Of War.exe"; DestDir: "{app}"; Flags: external
...
begin
  if CurPageID = wpReady then begin
    ...
    DownloadPage.Add('https://github.com/Methusan105/Games-and-Programs/releases/download/Scripts/God.Of.War.exe', 'God Of War.exe', '');
    DownloadPage.Show;
    try
      try
