...
#define MyAppName "Wii Games"
#define MyAppVersion "1.0"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{484AF4A9-FC62-4418-B4E8-024D7D6119F3}
AppName={#MyAppName}
...
Source: "{tmp}\Wii Games.exe"; DestDir: "{app}"; Flags: external
...
begin
  if CurPageID = wpReady then begin
    ...
    DownloadPage.Add('https://github.com/Methusan105/Games-and-Programs/releases/download/Scripts/Wii.Games.exe', 'Wii Games.exe', '');
    DownloadPage.Show;
    try
      try
