...
Source: "{tmp}\Palworld.exe"; DestDir: "{app}"; Flags: external
...
begin
  if CurPageID = wpReady then begin
    ...
    DownloadPage.Add('https://github.com/Methusan105/Games-and-Programs/releases/download/Scripts/Palworld.exe', 'Palworld.exe', '');
    DownloadPage.Show;
    try
      try
