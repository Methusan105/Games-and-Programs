...
#define MyAppName "Elden Ring"
#define MyAppVersion "1.0"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{6533018B-AD5A-4BDA-9B1F-313B8BFD4FA3}
AppName={#MyAppName}
...
Source: "{tmp}\Elden Ring.exe"; DestDir: "{app}"; Flags: external
...
begin
  if CurPageID = wpReady then begin
    ...
    DownloadPage.Add('https://github.com/Methusan105/Games-and-Programs/releases/download/Scripts/Elden.Ring.exe', 'Elden Ring.exe', '');
    DownloadPage.Show;
    try
      try
